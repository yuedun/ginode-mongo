...
type Component struct {
	...
	Title1        string             `json:"title_1" bson:"title_1"`               //一级标题
	Title2        string             `json:"title_2" bson:"title_2"`               //二级标题
	Title3        string             `json:"title_3" bson:"title_3"`               //三级标题
	Description   string             `json:"description" bson:"description"`       //文字描述
	BackgroundImg string             `json:"background_img" bson:"background_img"` //背景图
	BigImg        string             `json:"big_img" bson:"big_img"`               //展示大图
...
//Element 组件中包含的同类型元素
type Element struct {
	Icon        string `json:"icon" bson:"icon,omitempty"` //小图标
	Img         string `json:"img" bson:"img,omitempty"`   //大图
	...
	Link        string `json:"link" bson:"link,omitempty"` //跳转链接，也可以用作视频链接
}
